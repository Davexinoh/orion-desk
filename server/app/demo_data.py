ACME_INTENT_HINTS = ("meeting", "acme", "prepare me", "brief", "call")

ACME_PLAN = [
    {"delay": 0.7, "label": "Calendar inspected", "detail": None, "tool": "Calendar", "trace": "Reading your calendar..."},
    {"delay": 0.9, "label": "Email history analyzed", "detail": "6 threads", "tool": "Gmail", "trace": "Searching previous correspondence..."},
    {"delay": 0.8, "label": "Documents retrieved", "detail": "2 files", "tool": "Drive", "trace": "Pulling the files that actually matter..."},
    {"delay": 1.0, "label": "External research completed", "detail": None, "tool": "Web Search", "trace": "Looking up Acme..."},
    {"delay": 0.9, "label": "4 unresolved issues identified", "detail": None, "tool": "Gmail", "trace": "Finding what is still open..."},
    {"delay": 1.1, "label": "Meeting briefing generated", "detail": None, "tool": "Drive", "trace": "Writing the briefing..."},
    {"delay": 0.7, "label": "Preparation block scheduled", "detail": None, "tool": "Calendar", "trace": "Holding 1:00–2:00 PM for prep..."},
    {"delay": 0.8, "label": "Follow-up drafted", "detail": None, "tool": "Gmail", "trace": "Drafting the follow-up. Not sending it."},
]

ACME_PENDING = {"id": "send-agenda", "label": "Send agenda to 4 attendees"}
...
INTEGRATIONS = [
    {
        ...
        "connected": False,
        "status": "Add TELEGRAM_BOT_TOKEN to go live. Web chat works now.",
    ...
    },
    {
        "id": "web",
        "name": "Web Search",
        "role": "Research companies, people, and topics as part of a run.",
        "connected": True,
        "status": "Ready.",
...
def is_meeting_prep(intent: str) -> bool:
    t = intent.lower()
    return any(h in t for h in ACME_INTENT_HINTS)
